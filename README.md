...
--trainable_layers [10,11] \
--nb_epochs 10 \
--nb_epochs_finetune 10

7.a export CAM results

{'x': time point, 
'y': normalized gait value, 
'cas': normalized color value on CAM (higher is more important), 
'classes': which class it belongs to, 
'frame': which frame is this dataset, 
'i_x': index of example, 
'ts': cas values with all frames, 
'pred_label_map': which class the predicted,
 'orig_label_map': which class it should be}
